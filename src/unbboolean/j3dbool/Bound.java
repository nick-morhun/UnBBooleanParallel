...
public class Bound implements Cloneable {
    ...
    //----------------------------------OVERRIDES-----------------------------------//
     /**
     * Clones the bound object
     *
     * @return cloned bound object
     */
    public Object clone() {
        Bound o = new Bound(xMax, xMin, yMax, yMin, zMax, zMin);
        return o;
    }
     ...
     * Copy constructor.
     */
    private Bound(double xMax, double xMin, double yMax, double yMin,
